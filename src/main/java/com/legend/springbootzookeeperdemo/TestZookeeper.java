 ...
 * 2. 在new ZooKeeper时会立马返回一个对象，但真正连接的工作是线程异步去做的，所以要监测zk是否连接成功需要阻塞连接过程，这里使用CountDownLatch
...
public class TestZookeeper {
    public static void main(String[] args) throws IOException, KeeperException, InterruptedException {
        ...
        ZooKeeper zk = new ZooKeeper("127.0.0.1:2181",//192.168.6.31:2181,192.168.6.32:2181,192.168.6.33:2181
                300, new Watcher() {
            @Override
